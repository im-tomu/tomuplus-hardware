...
U 1 1 5798B89B
P 6595 3975
F 0 "C2" H 6605 4045 50  0000 L CNN
F 1 "2.2uF" H 6605 3895 50  0000 L CNN
F 2 "Capacitors_SMD:C_0402" H 6595 3975 50  0001 C CNN
F 3 "" H 6595 3975 50  0000 C CNN
	1    6595 3975
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5798BA02
P 6670 4175
F 0 "#PWR01" H 6670 3925 50  0001 C CNN
F 1 "GND" H 6670 4025 50  0000 C CNN
F 2 "" H 6670 4175 50  0000 C CNN
F 3 "" H 6670 4175 50  0000 C CNN
	1    6670 4175
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5798BA32
P 7470 3850
F 0 "C3" H 7480 3920 50  0000 L CNN
F 1 "47uF" H 7480 3770 50  0000 L CNN
F 2 "Capacitors_SMD:C_0402" H 7470 3850 50  0001 C CNN
F 3 "" H 7470 3850 50  0000 C CNN
	1    7470 3850
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5798BCD7
P 7105 4395
F 0 "C1" V 7055 4445 50  0000 L CNN
F 1 "1uF" V 7155 4445 50  0000 L CNN
F 2 "Capacitors_SMD:C_0402" H 7105 4395 50  0001 C CNN
F 3 "" H 7105 4395 50  0000 C CNN
	1    7105 4395
	0    1    1    0   
$EndComp
$Comp
...
U 1 1 5798BECB
P 7115 3250
F 0 "P3" H 7315 3050 50  0000 C CNN
F 1 "USB-PCB" H 7065 3450 50  0000 C CNN
F 2 "usb-pcb:USB-PCB" V 7065 3150 50  0001 C CNN
F 3 "" V 7065 3150 50  0000 C CNN
	1    7115 3250
	0    1    1    0   
$EndComp
Text Label 6295 3150 0    39   ~ 0
USB_D-
Text Label 6295 3250 0    39   ~ 0
USB_D+
Text Label 6300 3375 0    39   ~ 0
VCC3V3
Text Label 6295 3050 0    39   ~ 0
USB_5V
$Comp
L R_Small R3
U 1 1 5798C3BC
P 6120 3150
F 0 "R3" V 6155 3215 50  0000 L CNN
F 1 "33" V 6120 3120 39  0000 L CNN
F 2 "Resistors_SMD:R_0402" H 6120 3150 50  0001 C CNN
F 3 "" H 6120 3150 50  0000 C CNN
	1    6120 3150
	0    1    1    0   
$EndComp
$Comp
...
U 1 1 5798C529
P 6120 3250
F 0 "R4" V 6160 3315 50  0000 L CNN
F 1 "33" V 6120 3220 39  0000 L CNN
F 2 "Resistors_SMD:R_0402" H 6120 3250 50  0001 C CNN
F 3 "" H 6120 3250 50  0000 C CNN
	1    6120 3250
	0    1    1    0   
$EndComp
$Comp
...
U 1 1 5798EF1D
P 6470 3575
F 0 "#PWR03" H 6470 3425 50  0001 C CNN
F 1 "+3V3" H 6470 3715 50  0000 C CNN
F 2 "" H 6470 3575 50  0000 C CNN
F 3 "" H 6470 3575 50  0000 C CNN
	1    6470 3575
	1    0    0    -1  
$EndComp
$Comp
...
LEU0_RX
Text Label 7020 3815 0    39   ~ 0
DEC
Text Label 4175 2600 1    39   ~ 0
LED1
Text Label 4100 2600 1    39   ~ 0
LED0
Text Label 5970 3150 0    8    ~ 0
RUSB_D-
Text Label 5970 3250 0    8    ~ 0
RUSB_D+
...
Wire Wire Line
	6220 3625 5970 3625
Connection ~ 6220 3375
Connection ~ 6220 3625
Wire Wire Line
	6670 4125 6670 4175
Wire Wire Line
	6595 4125 6595 4075
Connection ~ 6670 4125
Connection ~ 6595 4125
Wire Wire Line
	6595 3375 6595 3875
Wire Wire Line
	6220 3375 6220 3700
...
Wire Wire Line
	6470 3625 6595 3625
Connection ~ 6595 3625
Wire Wire Line
	6815 3350 6815 4125
Connection ~ 6815 4125
Wire Wire Line
	3450 2675 3450 2625
Wire Wire Line
	3325 2625 3550 2625
...
Wire Wire Line
	4030 4025 4030 4035
Text Notes 6705 3845 1    60   ~ 0
Cout
Text Notes 5865 2390 0    60   ~ 0
...
U 1 1 5798B6D7
P 4870 4175
F 0 "U1" H 4820 4125 60  0000 C CNN
F 1 "MKL27Z256VFM4" H 5520 4850 39  0000 C CNN
F 2 "Housings_DFN_QFN:QFN-32-1EP_5x5mm_Pitch0.5mm" H 4870 4175 60  0001 C CNN
F 3 "" H 4870 4175 60  0000 C CNN
	1    4870 4175
	1    0    0    -1  
$EndComp
Wire Wire Line
...
Wire Wire Line
	5970 3900 6220 3900
Connection ~ 6220 3900
Wire Wire Line
	5970 3975 6220 3975
Connection ~ 6220 3975
Wire Wire Line
	5970 4050 6220 4050
Connection ~ 6220 4050
$EndSCHEMATC
